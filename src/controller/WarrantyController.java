...
public class WarrantyController {
    ...
    private int recordId() { int id = Integer.parseInt(recordIdField.getText().trim()); if (id <= 0) throw new IllegalArgumentException("Mã phiếu dịch vụ phải lớn hơn 0."); return id; }
