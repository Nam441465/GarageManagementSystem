...
public class WarrantyController {
    ...
    private int invoiceId() { int id = Integer.parseInt(invoiceIdField.getText().trim()); if (id <= 0) throw new IllegalArgumentException("Mã hóa đơn phải lớn hơn 0."); return id; }
