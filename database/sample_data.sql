...
-- 7. PriceList
INSERT INTO PriceList (service_id, vehicle_type, price, effective_from, effective_to, note) VALUES
    (1, 'SEDAN', 350000.00, '2026-01-01', NULL, 'Giá rửa xe cho xe sedan'),
    (1, 'SUV', 450000.00, '2026-01-01', NULL, 'Giá rửa xe cho xe SUV'),
    (2, 'SEDAN', 1500000.00, '2026-01-01', NULL, 'Dịch vụ bảo dưỡng định kỳ sedan'),
    (2, 'SUV', 1800000.00, '2026-01-01', NULL, 'Dịch vụ bảo dưỡng định kỳ SUV'),
    (3, 'SEDAN', 2500000.00, '2026-01-01', NULL, 'Sửa chữa động cơ sedan'),
    (4, 'PICKUP', 2200000.00, '2026-01-01', NULL, 'Thay lốp pickup'),
    (5, 'SEDAN', 1300000.00, '2026-01-01', NULL, 'Bảo dưỡng phanh sedan');
...
-- 10. ServiceRecord
INSERT INTO ServiceRecord (appointment_id, vehicle_id, record_date, notes, total_cost, created_by, employee_id, status) VALUES
    (1, 1, '2026-08-10', 'Bảo dưỡng định kỳ, kiểm tra phanh, xe chạy ổn định', 2800000.00, 1, 1, 'PAID'),
    (2, 2, '2026-08-12', 'Kiểm tra phanh, cần thay má phanh trong tương lai', 1300000.00, 1, 1, 'COMPLETED'),
    (NULL, 3, '2026-08-14', 'Lịch sửa chữa nhanh cho xe pickup', 4400000.00, 1, 1, 'OPEN');

-- 11. ServiceRecordDetail
INSERT INTO ServiceRecordDetail (service_record_id, service_id, quantity, price, subtotal, notes) VALUES
    (1, 2, 1, 1500000.00, 1500000.00, 'Bảo dưỡng định kỳ'),
    (1, 5, 1, 1300000.00, 1300000.00, 'Bảo dưỡng phanh'),
    (2, 5, 1, 1300000.00, 1300000.00, 'Kiểm tra phanh'),
    (3, 4, 2, 2200000.00, 4400000.00, 'Thay lốp cho pickup');

-- 12. Invoice
INSERT INTO Invoice (record_id, total_amount, issue_date, payment_status, payment_method, pdf_path) VALUES
    (1, 2800000.00, '2026-08-10', 'PAID', 'CASH', '/invoices/invoice-INV-0001.pdf'),
    (2, 1300000.00, '2026-08-12', 'PAID', 'BANK_TRANSFER', '/invoices/invoice-INV-0002.pdf'),
    (3, 4400000.00, '2026-08-14', 'UNPAID', 'CARD', '/invoices/invoice-INV-0003.pdf');
...
-- 14. Warranty
INSERT INTO Warranty (service_record_id, warranty_code, start_date, end_date, coverage, status) VALUES
...
INSERT INTO AuditLog (user_id, action, entity_name, entity_id, old_value, new_value, ip_address, device) VALUES
    ...
    (1, 'UPDATE_SERVICE_RECORD', 'ServiceRecord', 1, '{"status":"OPEN"}', '{"status":"PAID"}', '192.168.1.10', 'PC-Office'),
